...
Product-specific wrappers for Census data products.
...
Helpers for discovering datasets, variables, tables, geographies, and
examples.
...
- [`tc_dataset()`](https://christopherkenny.github.io/tinycensus/reference/tc_dataset.md)
...
- [`tc_table_variables()`](https://christopherkenny.github.io/tinycensus/reference/tc_table_variables.md)
...
- [`tc_geography()`](https://christopherkenny.github.io/tinycensus/reference/tc_geography.md)
  : Retrieve Census geography metadata
- [`tc_examples()`](https://christopherkenny.github.io/tinycensus/reference/tc_examples.md)
...
- [`tc_values()`](https://christopherkenny.github.io/tinycensus/reference/tc_values.md)
  : Retrieve encoded values metadata for a Census variable

## API key tools

Manage Census API credentials.

- [`tc_set_key()`](https://christopherkenny.github.io/tinycensus/reference/tc_set_key.md)
  : Set the Census API key
- [`tc_get_key()`](https://christopherkenny.github.io/tinycensus/reference/tc_get_key.md)
  : Get the Census API key
- [`tc_has_key()`](https://christopherkenny.github.io/tinycensus/reference/tc_has_key.md)
